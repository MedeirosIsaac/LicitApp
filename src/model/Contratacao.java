...
import enums.StatusContratacao;
...
public class Contratacao {
    ...
    // Relação de Composição: Uma Contratação possui uma lista de Documentos analíticos
    private List<Documento> documentos;

    public Contratacao() {
        this.id = UUID.randomUUID().toString(); // Garante a geração automática de um ID único
